  ...
  return (
    <section className="bg-gray-50 py-16 px-6 md:px-20 space-y-12">
      ...
      <div className="flex flex-col md:flex-row items-stretch gap-6">
        {/* Left: Image */}
        <div className="w-full rounded-2xl md:w-2/5 overflow-hidden">
          <Image
            src={whyUs1}
        ...
        {/* Right: Text Content */}
        <div className="w-full md:w-3/5 rounded-2xl flex flex-col justify-center">
          <h3 className="text-2xl md:text-3xl font-bold text-[#0F3069] mb-4">
            Live Instructor-Led Classes in Fremont, California
          </h3>
          <p className="text-[#0F3069] text-md leading-relaxed mb-6">
            <span className="text-[#0F3069] text-xl font-semibold leading-relaxed mb-7">
          ...
          <button className="bg-[#FF6575] hover:bg-[#e45061] text-white font-semibold px-5 py-2 w-60 rounded-lg transition">
